...
DBM = {
	Revision = parseCurseDate("20260314000000"),
	DisplayVersion = "10.1.13 alpha", -- the string that is shown as version
	ReleaseRevision = releaseDate(2026, 03, 14) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
